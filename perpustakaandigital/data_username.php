...
<body>
  <div class="action-buttons">
    ...
    <a href="Username.php">Input Data</a>
  </div>
  <div class="container">
    ...
    <tr>
        ...
        <td><a href="formedituser.php?iduser=<?php echo $tampil['id_user'];?>" onclick="return confirm('Apakah Anda Yakin?')">Edit</a></td>
        <td><a href="deleteuser.php?iduser=<?php echo $tampil['id_user'];?>" onclick="return confirm('Apakah Anda Yakin?')">Delete</a></td>
    </tr>
    <?php } ?>
    </table>
      </tbody>
