...
<head>
    ...
    <title>Form Data Peminjaman Buku</title>
    <style>
        body {
    ...
    <div class="container">
        <form action="proses_peminjaman.php" method="post" name="proses_buku">
            ...
            <div class="form-group">
                ...
                <input type="text" name="id_peminjaman" placeholder="Enter User ID" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="id_buku" required>
                    <?php 
                        ...
                        while($tampil = mysqli_fetch_array($data)){
                            echo "<option value='".$tampil['id_buku']."'>".$tampil['id_buku']."-".$tampil['kategori_buku']."</option>";"</option>";
                        }
                    ?>
                </select>
            </div>
