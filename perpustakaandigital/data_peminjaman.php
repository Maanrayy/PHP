...
<body>
  <div class="action-buttons">
    ...
    <a href="peminjaman.php">Input Data</a>
  </div>
  <div class="container">
    ...
    <tr>
        ...
        <td><a href="formedit_peminjaman.php?idpinjam=<?php echo $tampil['id_peminjaman'];?>" onclick="return confirm('Apakah Anda Yakin?')">Edit</a></td>
        <td><a href="delete_peminjaman.php?idpinjam=<?php echo $tampil['id_peminjaman'];?>" onclick="return confirm('Apakah Anda Yakin?')">Delete</a></td>
    </tr>
    <?php } ?>
      </tbody>
    </table>
