    ...
    <div class="container">
        <form action="proses_anggota.php" method="post" name="prosesanggota">
            ...
            <div class="form-group">
                ...
                <input type="text" id="user_id" name="id_anggota" placeholder="Enter User Anggota">
            </div>
            <div class="form-group">
                <label for="username">Nama:</label>
                <input type="text" id="username" name="nama" placeholder="Enter Name">
            </div>
            <div class="form-group">
                <label for="password">Alamat:</label>
                <input type="text" id="password" name="alamat" placeholder="Enter Alamat">
            </div>
            <div class="form-group">
                <label for="email">Telepon:</label>
                <input type="text" id="email" name="telepon" placeholder="Enter Telepon">
            </div>
            <div class="form-group">
