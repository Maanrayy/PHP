...
<body>
  <div class="action-buttons">
    ...
    <a href="databuku.php">Input Data</a>
  </div>
  <div class="container">
    <h2>Data Buku</h2>
    <table>
    ...
    <tr>
        ...
        <td><a href="formeditbuku.php?idbuku=<?php echo $tampil['id_buku'];?>" onclick="return confirm('Apakah Anda Yakin?')">Edit</a></td>
        <td><a href="deletebuku.php?idbuku=<?php echo $tampil['id_buku'];?>" onclick="return confirm('Apakah Anda Yakin?')">Delete</a></td>
    </tr>
    <?php } ?>
      </tbody>
    </table>
