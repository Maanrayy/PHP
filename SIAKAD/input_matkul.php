...
<a href="INDEX.html"><button class="dropbtn">DASHBOARD</button></a>
  ...
  <div class="leftcolumn">
    <div class="card">
      <form action="proses_matkul.php" method="post" name="inputMhs">
        <table border="0">
        <tr><td width ="200">Id Matkul </td>
        <td><input type="text" name="idMatkul" placeholder="Id"></td>
        </tr>
          
        <tr><td>Nama Matkul</td>
          <td><input type="text" name="namaMatkul" placeholder="Nama"></td>
          </tr>
          ...
          ?>
              <option value="<?php echo $tampil['idDosen'];?>"><?php echo $tampil ['idDosen'];?></option>
            <?php } ?>
          </select>
          </td>
          </tr>
