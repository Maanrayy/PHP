...
<table id="customers">
  <tr>
    <th width="100">Nomor Induk Dosen</th>
  ...
  <?php
    include 'koneksi.php';
    $datauser = mysqli_query($kon,"select * from dosen");
    while ($tampil = mysqli_fetch_array($datauser)){
    ?>
    <tr>
        <td><?php echo $tampil ['idDosen'];?></td>
        <td><?php echo $tampil ['namaDosen'];?></td>
        <td><?php echo $tampil ['jkDosen'];?></td>
        <td><?php echo $tampil ['tmplDosen'];?></td>
        <td><?php echo $tampil ['tgllhrDosen'];?></td>
        <td><?php echo $tampil ['telpDosen'];?></td>
        <td><?php echo $tampil ['alamatDosen'];?></td>
        <td><?php echo $tampil ['idUsername'];?></td>
        <td><a href="formedit_dosen.php?iddosen=<?php echo $tampil['idDosen'];?>" onclick="return confirm('Apakah Anda Yakin?')">Edit</a></td>
        <td><a href="deletedosen.php?iddosen=<?php echo $tampil['idDosen'];?>" onclick="return confirm('Apakah Anda Yakin?')">Delete</a></td>
    </tr>
    <?php } ?>
</table>
</body>
