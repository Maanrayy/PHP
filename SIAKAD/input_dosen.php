...
<a href="INDEX.html"><button class="dropbtn">DASHBOARD</button></a>
  ...
  <div class="leftcolumn">
    <div class="card">
      <form action="proses_dosen.php" method="post" name="Dosen">
        <table border="0">
        <tr><td width ="200">ID Dosen </td>
        <td><input type="text" name="idDosen" placeholder="ID Dosen"></td>
        </tr>
          
        <tr><td>Nama Dosen</td>
          <td><input type="text" name="namaDosen" placeholder="Nama Dosen"></td>
          </tr>
         
          <tr><td>Jenis kelamin</td>
          <td><input type="radio" name="jkDosen" value="laki-laki">laki-laki
          <input type="radio" name="jkDosen"value="perempuan">perempuan</td>
          </tr>

          <tr><td>Tempat Tanggal Lahir</td>
          <td><input type="text" name="tmplDosen" placeholder="Tempat">
          <input type="date" name="tgllhrDosen"></td>
          </tr>

          <tr><td>Telepon</td>
          <td><input type="text" name="telpDosen" placeholder="Telepon"></td>
          </tr>

          <tr><td>Alamat</td>
          <td><input type="text" name="alamatDosen" placeholder="Alamat"></td>
          </tr>
