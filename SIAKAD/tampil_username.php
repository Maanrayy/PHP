...
<a href="INDEX.html"><button class="dropbtn">DASHBOARD</button></a>
  ...
  <div class="topnav">
  <a href="tampil_username.php">LIHAT DATA</a>
    <a href="input_username.php">INPUT USERNAME</a>
  </div>
...
<table id="customers">
  <tr>
    <th width="100">Id Username</th>
    <th width="200">Username</th>
    <th width="210">Password</th>
    <th>Update</th>
    <th>Update</th>
    ...
    <tr>
        ...
        <td><a href="formedituser.php?iduser=<?php echo $tampil['idUsername'];?>" onclick="return confirm('Apakah Anda Yakin?')">Edit</a></td>
        <td><a href="deleteuser.php?iduser=<?php echo $tampil['idUsername'];?>" onclick="return confirm('Apakah Anda Yakin?')">Delete</a></td>
    </tr>
    <?php } ?>
    </table>
</div>
