...
<a href="INDEX.html"><button class="dropbtn">DASHBOARD</button></a>
  ...
  <div class="topnav">
    ...
    <a href="input_mahasiwa.php">INPUT USERNAME</a>
  </div>
  <div class="leftcolumn">
    ...
    include 'koneksi.php';
    $idEdit = $_GET['iduser'];
    $dataEdit = mysqli_query($kon, "select * from username where idUsername= '$idEdit'");
    while($tampil = mysqli_fetch_array($dataEdit)){
?>
      <form action="edituser.php" method="post" name="inputMhs">
        <table border="0">
        <tr><td width ="200">Id Username </td>
