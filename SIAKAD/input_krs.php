...
<a href="INDEX.html"><button class="dropbtn">DASHBOARD</button></a>
  ...
  <div class="leftcolumn">
    <div class="card">
      <form action="proses_krs.php" method="post" name="inputMhs">
        <table border="0">
        <tr><td width ="200">ID KRS </td>
        <td><input type="text" name="idKrs" placeholder="Krs"></td>
        </tr>
          ...
          <select name="idMhs">
                <?php 
                  include 'koneksi.php';
                  $data1=mysqli_query ($kon, "select * from mahasiswa");
                  while($tampil1 = mysqli_fetch_array($data1)){
                ?>
                <option value="<?php echo $tampil1['idMhs'];?>"><?php echo $tampil1 ['idMhs'];?></option>
                <?php } ?>
              </select>
          </td>
          </tr>
          ...
          <tr><td>ID Matkul</td>
          <td>
          <select name="idMatkul">
                <?php 
                  include 'koneksi.php';
                  $data1=mysqli_query ($kon, "select * from matkul");
                  while($tampil1 = mysqli_fetch_array($data1)){
                ?>
                <option value="<?php echo $tampil1['idMatkul'];?>"><?php echo $tampil1 ['idMatkul'];?></option>
                <?php } ?>
              </select>
          </td>
          </tr>
          ...
          <tr><td>Nilai Uts</td>
          <td><input type="text" name="nilaiUts" placeholder="UTS"></td>
          </tr>

          <tr><td>Nilai UAS</td>
          <td><input type="text" name="nilaiUas" placeholder="UAS"></td>
          </tr>
          </td>
          </tr>
