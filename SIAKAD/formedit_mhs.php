...
<a href="INDEX.html"><button class="dropbtn">DASHBOARD</button></a>
  ...
  <div class="topnav">
    ...
    <a href="input_mahasiswa.php">INPUT DOSEN</a>
  </div>
  <div class="leftcolumn">
    ...
    include 'koneksi.php';
    $idEdit = $_GET['idmhs'];
    $dataEdit = mysqli_query($kon, "select * from mahasiswa where idMhs= '$idEdit'");
    while($tampil = mysqli_fetch_array($dataEdit)){
?>
      <form action="editmhs.php" method="post" name="inputMhs">
        <table border="0">
        <tr><td width ="200">Id Mahasiswa </td>
        <td><input type="text" name="idMhs" value="<?php echo $tampil['idMhs']?>"readonly></td>
        </tr>
          
        <tr><td>Nama Mahasiswa</td>
          <td><input type="text" name="namaMhs" value="<?php echo $tampil['namaMhs']?>"></td>
          </tr>
         
          <tr><td>Jenis Kelamin</td>
          <td><input type="text" name="jkMhs" value="<?php echo $tampil['jkMhs']?>"></td>

          <tr><td>Tempat lahir</td>
          <td><input type="text" name="tmplMhs" value="<?php echo $tampil['tmplMhs']?>"></td>

          <tr><td>Tanggal Lahir</td>
          <td><input type="text" name="tgllhrMhs" value="<?php echo $tampil['tgllhrMhs']?>"></td>

          <tr><td>Telepon</td>
          <td><input type="text" name="telpMhs" value="<?php echo $tampil['telpMhs']?>"></td>

          <tr><td>ID Username</td>
          <td><input type="text" name="idUsername" value="<?php echo $tampil['idUsername']?>"readonly></td>
