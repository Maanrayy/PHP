...
<a href="INDEX.html"><button class="dropbtn">DASHBOARD</button></a>
  ...
  <div class="topnav">
    <a href="tampil_matkul.php">LIHAT DATA</a>
    <a href="input_matkul.php">INPUT USERNAME</a>
  </div>
  <div class="leftcolumn">
    ...
    include 'koneksi.php';
    $idEdit = $_GET['iduser'];
    $dataEdit = mysqli_query($kon, "select * from matkul where idMatkul= '$idEdit'");
    while($tampil = mysqli_fetch_array($dataEdit)){
?>
      <form action="editmatkul.php" method="post" name="inputMhs">
        <table border="0">
        <tr><td width ="200">Id Matkul </td>
        <td><input type="text" name="idMatkul" value="<?php echo $tampil['idMatkul']?>"readonly></td>
        </tr>
          
        <tr><td>Nama matkul</td>
          <td><input type="text" name="namaMatkul" value="<?php echo $tampil['namaMatkul']?>"></td>
          </tr>
