...
<a href="INDEX.html"><button class="dropbtn">DASHBOARD</button></a>
  ...
  <div class="leftcolumn">
    ...
    <button><a target="_blank" href="excel_mhs.php">Export Excel</a></button>
    <button><a target="_blank" href="pdf_mhs.php">Export PDF</a></button>
...
<table id="customers">
  ...
  <?php
    ...
    <tr>
        ...
        <td><a href="formedit_mhs.php?idmhs=<?php echo $tampil['idMhs'];?>" onclick="return confirm('Apakah Anda Yakin?')">Edit</a></td>
        <td><a href="delete_mhs.php?idmhs=<?php echo $tampil['idMhs'];?>" onclick="return confirm('Apakah Anda Yakin?')">Delete</a></td>
    </tr>
    <?php } ?>
</table>
</body>
