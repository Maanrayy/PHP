...
<a href="INDEX.html"><button class="dropbtn">DASHBOARD</button></a>
  ...
  <div class="leftcolumn">
    ...
    include 'koneksi.php';
    $idEdit = $_GET['idkrs'];
    $dataEdit = mysqli_query($kon, "select * from krs where idKrs= '$idEdit'");
    while($tampil = mysqli_fetch_array($dataEdit)){
?>
      <form action="editkrs.php" method="post" name="inputMhs">
        <table border="0">
        <tr><td width ="200">Id KRS </td>
        <td><input type="text" name="idKrs" value="<?php echo $tampil['idKrs']?>"readonly></td>
        </tr>
        ...
        <tr><td>Id Mahasiswa</td>
          ...
          <tr><td>Id Matkul</td>
          <td><input type="text" name="idMatkul" value="<?php echo $tampil['idMatkul']?>"readonly></td>

          <tr><td>Nilai Uts</td>
          <td><input type="text" name="nilaiUts" value="<?php echo $tampil['nilaiUts']?>"></td>

          <tr><td>Nilai Uas</td>
          <td><input type="text" name="nilaiUas" value="<?php echo $tampil['nilaiUas']?>"></td>
